...
public class UserController {
	...
	/*
	 * @GetMapping("/findbyData/{date}/{arrivalLoc}/{departureLoc}") public Flight[]
	 * getFlightByDateAndArrivalLocAndDepartureLoc(
	 * 
	 * @PathVariable String date,@PathVariable String arrivalLoc,@PathVariable
	 * String departureLoc){ Flight[]
	 * flight=restTemplate.getForObject("http://localhost:8081/flight/findbyData/"+
	 * date+"/"+arrivalLoc+"/"+departureLoc, Flight[].class) ; return flight; }
	 */
